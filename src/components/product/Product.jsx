      ...
      <div className="flex flex-wrap justify-evenly items-center h-full">
        <div className="flex flex-col justify-center items-center gap-5">
          <div className="relative">
            <img
              ...
              className="w-full h-[20rem] md:rounded-md md:w-[23rem] md:h-[22rem] object-center object-cover cursor-pointer"
              src={selectedImage}
            />
            <div
        ...
        <div className="h-full w-full px-5 py-6 md:py-0 md:w-[23rem] md:px-0">
          ...
          <div className="flex justify-start items-center gap-4">
            ...
            <p className="bg-pale-orange text-orange font-bold px-2 rounded-md mr-auto">
              50%
            </p>
          ...
          <div className="flex md:flex-nowrap flex-wrap  w-full justify-start items-center gap-3 h-[6rem] text-[0.9rem] font-bold">
            <div className="flex justify-between md:justify-center items-center md:w-1/2 w-full bg-light-grayish-blue mt-3 md:mt-0 rounded-lg">
              <button
                disabled={quantity === 0 ? true : false}
                onClick={handleDecreaseQuantity}
                className="w-12 h-12 flex justify-center items-center hover:opacity-75 pt-3"
              >
                <MinusIcon minusStyle="fill-current text-orange w-5 h-5" />
              </button>
              <button className="w-12 h-12">{quantity}</button>
              <button
                onClick={handleIncreaseQuantity}
                className="w-12 h-12 flex justify-center items-center hover:opacity-75 pt-2"
              >
